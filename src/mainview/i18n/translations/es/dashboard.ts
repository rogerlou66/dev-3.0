const dashboard = {
	...
	"dashboard.firstRun.connectAgentAction": "Conecta un agente primero",
	"dashboard.firstRun.noAgentInstalled": "No se encontró ninguna CLI de agente en esta máquina. Instala una — Claude Code, Codex, Gemini, Cursor Agent u OpenCode — y dev-3.0 la detectará.",
	"dashboard.firstRun.noAgentSignedIn": "Hay una CLI de agente instalada pero sin sesión iniciada. Ejecútala una vez en la terminal e inicia sesión; una tarea de pruebas moriría en la pantalla de login.",
	...
	"workspaceBoard.open": "Abrir",
	"workspaceBoard.done": "Hecho",
	"workspaceBoard.noActiveSummary": "Sin tareas activas · {count} completadas",
	...
	"activity.todoOnBoard_one": "{count} en To Do",
	"activity.todoOnBoard_other": "{count} en To Do",
	...
	"android.connection.switchComputer": "Conectar otro ordenador",
	"android.connection.forgetComputer": "Olvidar ordenador",
	"android.connection.actionFailed": "No se pudo actualizar la conexión con el ordenador. Inténtalo de nuevo. ({error})",
	...
	"header.switchVariant": "Cambiar variante",
	...
	"remote.anywhereToggleCustom": "Accesible desde cualquier lugar (túnel propio)",
	"remote.customTunnelNotFound": "No se encontró el comando del túnel personalizado",
	"remote.customTunnelNotFoundHint": "El shell no pudo ejecutarlo (código 127). Revisa el comando en Ajustes o instala la herramienta que ejecuta.",
	"remote.customTunnelEmpty": "El comando del túnel personalizado está vacío",
	"remote.customTunnelEmptyHint": "Configura el comando en los ajustes del túnel: no se inicia ningún túnel hasta completarlo.",
	"remote.tunnelSettingsLink": "Ajustes del túnel",
	...
	"remote.recheckTunnelBinary": "Verificar de nuevo",
