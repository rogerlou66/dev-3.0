const settings = {
	...
	"catalog.providerKeyStored": "Hay una clave guardada. Escribe otra para reemplazarla; las claves no salen de esta máquina y no vuelven a mostrarse.",
	"catalog.providerKeyMissing": "Sin clave — el proveedor no es accesible sin ella.",
