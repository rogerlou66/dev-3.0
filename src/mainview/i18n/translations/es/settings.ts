const settings = {
	...
	"settings.categoryModels": "Modelos",
	...
	"catalog.section": "Catálogo de modelos",
	...
	"catalog.proxyStopped": "Proxy de modelos detenido — arranca solo cuando un agente lo necesita",
	...
	"catalog.modelIdManual": "Arranca el proxy y carga la lista, o escribe el id tú mismo.",
	...
	"catalog.firstRunStep2": "Dale a uno de sus modelos un nombre corto tuyo.",
	"catalog.firstRunStep3": "Guarda y vincula ese nombre a un rol del agente en Ajustes → Agentes.",
	"catalog.startNeedsModel": "Guarda al menos un modelo primero — el proxy aún no tiene nada que servir.",
