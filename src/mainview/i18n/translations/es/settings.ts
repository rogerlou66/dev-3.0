const settings = {
	...
	"settings.installDev3CliDesc": "Crear symlink del CLI de esta instancia en ~/.dev3.0/bin/dev3 y preparar un dev3-self que siempre habla con ESTA instancia. Los hooks de los agentes siguen usando dev3, así que su enrutamiento no cambia.",
	"settings.installDev3CliArmed": "Preparado {shim} → --instance {instance}. Ejecuta dev3-self en una terminal para llegar a esta instancia.",
	...
	"settings.agentFamily": "Qué CLI es este",
	"settings.familyHint": "dev3 tratará al agente exactamente como al CLI que elijas aquí: flags de lanzamiento, reanudación de sesiones, hooks. «Auto» se basa en el comando base.",
	"settings.familyAuto": "Auto — {family}",
	...
	"settings.terminalShellDesc": "Qué shell ejecuta dev3 en sus terminales y scripts. Automático sigue tu shell de inicio de sesión y, si no está disponible, usa el primero instalado entre zsh, bash y sh. Se ignora en Windows, que usa PowerShell.",
	"settings.terminalShellAuto": "Automático",
	...
	"settings.agentLaunchAutoApproveMinutes_one": "Tras {count} minuto",
	"settings.agentLaunchAutoApproveMinutes_other": "Tras {count} minutos",
	...
	"settings.remoteTunnel": "Proveedor de túnel",
	"settings.remoteTunnelDesc": "Cómo se crean los túneles públicos: tanto la URL de acceso remoto como los puertos expuestos por tarea. El Cloudflare quick tunnel integrado no requiere configuración; con tu propio túnel puedes usar cualquier CLI tipo ngrok.",
	"settings.remoteTunnelCloudflare": "Cloudflare Quick Tunnel (integrado)",
	"settings.remoteTunnelCustom": "Comando personalizado (túnel propio)",
	"settings.remoteTunnelCommand": "Comando del túnel",
	"settings.remoteTunnelCommandRequired": "Obligatorio: mientras esté vacío no se inicia ningún túnel (dev3 no vuelve a Cloudflare).",
	"settings.remoteTunnelCommandHint": "{port} se reemplaza por el puerto local. La URL pública se lee de la salida del comando. Cada túnel ejecuta su propia instancia del comando; un comando con hostname fijo solo puede servir un túnel a la vez.",
	"settings.remoteTunnelUrlPattern": "Patrón de URL pública (opcional)",
	"settings.remoteTunnelUrlPatternHint": "Expresión regular que coincide con la URL pública en la salida del comando. Vacío = la primera URL https:// impresa. Un grupo de captura, si existe, selecciona la URL.",
	...
	"settings.coordinatorPrompt": "Prompt de coordinador",
	"settings.coordinatorPromptDesc": "Texto que el tipo de tarea Coordinador coloca sobre el tuyo en la ventana de nueva tarea. Está en inglés a propósito: lo lee un agente. Un proyecto puede sobrescribirlo en Ajustes del proyecto → Project Config.",
	"settings.coordinatorPromptReset": "Restablecer al valor predeterminado",
	"settings.coordinatorPromptCustom": "Se usa un prompt personalizado",
	...
	"projectSettings.projectName": "Nombre del proyecto",
	"projectSettings.projectNameDesc": "Cómo se llama este proyecto dentro de dev3. Cambiar el nombre solo afecta al nombre: la carpeta en disco, sus worktrees y sus tareas no se mueven.",
	"projectSettings.projectNamePlaceholder": "Nombre del proyecto",
	"projectSettings.projectNameEmpty": "El proyecto necesita un nombre.",
	...
	"projectSettings.coordinatorPrompt": "Prompt de coordinador",
	"projectSettings.coordinatorPromptDesc": "Texto que el tipo de tarea Coordinador coloca sobre el tuyo en la ventana de nueva tarea, solo para este proyecto. Déjalo vacío para usar el de Ajustes → Tareas y tablero.",
	"projectSettings.coordinatorPromptReset": "Volver al heredado",
	"projectSettings.coordinatorPromptCopyInherited": "Partir del texto heredado",
	"projectSettings.coordinatorPromptOverride": "Este proyecto sobrescribe el prompt global",
	"projectSettings.coordinatorPromptInherited": "Heredado de los ajustes globales",
	...
	"connect.descCustom": "Cualquier endpoint compatible con OpenAI o Anthropic indicado por URL.",
	"connect.keyLabel": "Clave de API de {provider}",
	"connect.keyHint": "Se guarda solo en esta máquina. Nunca llega a la configuración del agente, la línea de comandos ni los registros.",
	"connect.noKeyNeeded": "Este no necesita clave — dev3 habla con él directamente.",
	"connect.apiFormatLabel": "Formato de la API",
	"connect.apiFormat.openai": "Compatible con OpenAI",
	"connect.apiFormat.anthropic": "Compatible con Anthropic",
	"connect.apiFormatHint": "Qué formato espera el endpoint. En ambos casos el agente solo habla con el proxy local de dev3, que traduce.",
	"connect.baseUrlLabel": "URL del endpoint",
	"connect.willAdd": "Lo que obtienes de inmediato",
	"connect.willAddPreset": "Un preset listo para usar en Claude Code y Codex",
	"connect.willAddManual": "El proveedor. Nombrar los modelos que sirve es el siguiente paso, en Ajustes.",
	"connect.connect": "Conectar",
	"connect.connecting": "Conectando…",
	"connect.back": "Atrás",
	"connect.cancel": "Cancelar",
	"connect.connected": "{provider} conectado — los modelos ya están en la lista",
	"connect.connectedManual": "{provider} añadido. Nombra los modelos que sirve en Ajustes.",
	"connect.error": "No se pudo conectar: {error}",
	"recommendedUpdate.notice": "Hay nuevos modelos recomendados",
	"recommendedUpdate.review": "Revisar",
	"recommendedUpdate.title": "Nuevos modelos recomendados",
	"recommendedUpdate.subtitle": "dev3 ahora recomienda otro conjunto para este preset. Nada cambia hasta que lo apruebes.",
	"recommendedUpdate.unbound": "sin definir",
	"recommendedUpdate.newPreset": "nuevo preajuste",
	"recommendedUpdate.keepHint": "Conservar los tuyos es definitivo: no volveremos a preguntar por este conjunto.",
	"recommendedUpdate.keep": "Conservar los míos",
	"recommendedUpdate.apply": "Usar el nuevo conjunto",
	"recommendedUpdate.applying": "Actualizando…",
	"recommendedUpdate.applied": "Preset actualizado a los nuevos modelos recomendados",
	"recommendedUpdate.error": "No se pudo actualizar: {error}",
	"recommendedUpdate.noProvider": "Ningún proveedor conectado puede servir ya los modelos recomendados.",
	"catalog.subscriptionNote": "La clave aquí es una clave de API que se paga por tokens. Una suscripción como Claude Max o ChatGPT Plus no lo es: su cuota pertenece a la app del propio proveedor y no se puede alcanzar a través del proxy.",
	...
	"catalog.providerKeyStored": "Hay una clave guardada — muéstrala para editarla o reemplazarla.",
	"catalog.providerKeyShow": "Mostrar la clave",
	"catalog.providerKeyHide": "Ocultar la clave",
	"catalog.providerKeyRemoving": "La clave se eliminará al guardar.",
	"catalog.providerKeyRevealError": "No se pudo leer la clave guardada: {error}",
	...
	"catalog.rolesHint": "Sirve cada rol de este agente con un modelo de tu catálogo. Un rol vacío usa el modelo con el que arranca este preajuste; ya no lo sirve el modelo propio del agente.",
	"catalog.roleUnassigned": "Como el modelo de arranque",
	...
	"spaces.reorderSpace": "Arrastra para reordenar los espacios",
	"spaces.moveUp": "Mover arriba",
	"spaces.moveDown": "Mover abajo",
	"spaces.railLabel": "Espacios",
	"spaces.railOverview": "Resumen",
	"spaces.railAllProjects": "Todo",
	"spaces.filterTitle": "Filtrar por space",
	"spaces.railSpaces": "Espacios",
	"spaces.homeGroup": "Home",
	"spaces.addProjectsSearch": "Buscar proyectos…",
	"spaces.noProjectsMatch": "Ningún proyecto coincide",
	"spaces.addProjectsNewProject": "Nuevo proyecto…",
	"spaces.editProjectsMenu": "Editar proyectos…",
	"spaces.editProjectsTitle": "Proyectos en {name}",
	"spaces.editProjectsHint": "Marca un proyecto para incluirlo en este espacio, desmárcalo para quitarlo. Nada se mueve en el disco.",
	"spaces.editProjectsSubmit": "Guardar",
	"spaces.editProjectsEmpty": "Aún no hay proyectos para agrupar",
	"spaces.addToSpace": "Añadir a un espacio",
	"spaces.removeFromSpace": "Quitar de {name}",
	"spaces.rowAction": "Espacios…",
	"spaces.needYou": "{count} te esperan",
	"spaces.working": "{count} en curso",
	"spaces.projectCount_one": "{count} proyecto",
	"spaces.projectCount_other": "{count} proyectos",
	...
	"spaces.markSensitive": "Ocultar en cámara",
	"spaces.unmarkSensitive": "Mostrar en cámara",
