...
const help = {
	...
	"help.dashboard.workspaceBoard.body": "Work across every project in one aligned board. Moves stay inside each project; questions appear as amber Needs input cards in Agent Working.",
