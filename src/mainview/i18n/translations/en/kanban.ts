const kanban = {
	...
	"workspaceCard.fullTitle": "Task title",
	"workspaceCard.latestUpdate": "Latest update",
	"workspaceCard.noLatestUpdate": "No agent update yet.",
	...
	"createTask.taskTypeStandard": "Standard",
	"createTask.taskTypeCoordinator": "Coordinator",
	...
	// TaskCard
	"task.moveTo": "Move to",
	"task.prReviewBadge": "PR review",
	"task.prReviewHint": "Reviews someone else’s changes on this branch.",
	...
	"task.devStopFailed": "Could not stop the dev server: {error}",
	"task.watch": "Watch",
