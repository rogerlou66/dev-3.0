const tips = {
	...
	"tip.projectTerminal.body": "Нужен shell в корне репо? Используйте Terminal в шапке или переназначаемый хоткей.",
	...
	"tip.spaceSearch.title": "Переход по пространству",
	"tip.spaceSearch.body": "⌘K ищет и по названиям пространств — введите название, чтобы увидеть его проекты, а задачи фильтруйте через `space:\"Client X\"`.",
	"tip.agentTrafficLog.title": "Прочитай, о чём говорили агенты",
	"tip.agentTrafficLog.body": "Нажми \u21e7\u2318M — журнал трафика: 30 дней всех сообщений, которые агенты набрали друг другу.",
	"tip.remoteSelfUpdate.title": "Удалённая машина обновляется сама",
	"tip.remoteSelfUpdate.body": "Сервер `dev3 remote` ставит обновления сам, когда машина затихла, и сохраняет публичную ссылку — или запустите `dev3 update` вручную.",
};
