const kanban = {
	"task.blocked": "Заблокировано",
	"task.block": "Заблокировать задачу",
	"task.unblock": "Разблокировать задачу",
	"task.blockedDescription": "Ожидание внешней зависимости. Перетащите сюда задачу с ревью: она исчезнет из Inbox, но рабочая среда продолжит работать.",
	"task.failedBlock": "Не удалось изменить блокировку: {error}",
	// KanbanColumn
	...
	"workspaceCard.fullTitle": "Название задачи",
	"workspaceCard.latestUpdate": "Последнее обновление",
	"workspaceCard.noLatestUpdate": "Агент ещё не оставил обновление.",
	...
	"createTask.taskType": "Тип задачи",
	"createTask.taskTypeStandard": "Обычная",
	"createTask.taskTypeCoordinator": "Координатор",
	...
	"task.prReviewBadge": "PR-ревью",
	"task.prReviewHint": "Ревью чужих изменений в этой ветке.",
	...
	"task.disconnectedBadge": "Отключена",
	"task.disconnectedHint": "Сессия агента не пережила прошлое завершение работы. Worktree и изменения не тронуты — откройте задачу, чтобы восстановить сессию или начать новую.",
	...
	"launch.failedLaunchHintShell": "dev3 не смог определить оболочку для терминала агента — сам агент здесь не виноват. Пожалуйста, сообщите об этом.",
