...
6. **Work across projects → use Dashboard → Board.** The workspace board aligns every project as a swimlane; questions stay in Agent Working as amber **Needs input** cards, while AI Review and PR Review appear only when occupied. Open **Projects** beside Board for project management, or hover a card for a live terminal preview.
